const useStyles = () => {
	...
	return {
		...
		div: ' d-flex align-items-center  py-5 col-11  ',
		userimg: 'col-3  d-flex h-100 align-items-center justify-content-center ',
		containerColor: 'col-9 h-100   ',
		textLevel: 'col-12 d-flex  ',
		cajita: 'col-12   bg-light cajita',
		calendar: 'col-12  d-flex  ',
		line: 'col-12  d-flex  my-3 ',
		summary: 'col-7  d-flex justify-content-center align-items-center',
		see: 'col-5',
