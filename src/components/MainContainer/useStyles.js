const useStyles = ({ backgroundImg, scroll, col, banner }) => {
    ...
    return {
        ...
        bodyContainer: `col-${col} d-flex flex-column justify-content-between ${ scroll ? '' : 'main-container__body'}${ banner ? '--banner' : ''}`
    }
}
